...
public class CovidController {
    ...
    @GetMapping(value = "/v1/covid", produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<String> get(){
        return covidService.updateBaseCovid();
    }
    ...
    @GetMapping(value = "/v1/covid/update", produces = MediaType.APPLICATION_JSON_VALUE)
